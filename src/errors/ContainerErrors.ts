 ...
 */
export class CrashLoopDetectedError extends Data.TaggedError(
 ...
 */
export class ContainerNotStoppedError extends Data.TaggedError(
 ...
 */
export class BaselineContainerError extends Data.TaggedError(
 ...
 */
export class ContainerStartError extends Data.TaggedError(
	"ContainerStartError",
)<{
	readonly name: string;
