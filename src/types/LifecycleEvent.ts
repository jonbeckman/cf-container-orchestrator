 ...
 */
export const createErrorEvent = (containerName: string, error: string): LifecycleEvent => ({
  type: "error",
  containerName,
  timestamp: Date.now(),
  error,
 ...
 */
export const createVersionRolloutEvent = (containerName: string): LifecycleEvent => ({
  type: "stopped",
  containerName,
  timestamp: Date.now(),
